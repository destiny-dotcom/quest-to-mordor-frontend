...
const WIZARD_STEPS: WizardStep[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Tap the input field (where you select what to calculate)",
      "Look above your keyboard for \"Health Samples\" - tap it",
      "If you don't see it, tap \"Clear\" first, then tap the field again",
      "Make sure \"Sum\" is selected for the operation",
    ],
    config: [
      { label: "Input", value: "Health Samples (from step above)" },
      { label: "Operation", value: "Sum" },
    ],
    tip: "The Health Samples variable appears above your keyboard after tapping the input",
  },
  {
    title: "Send to Quest",
    ...
    instructions: [
      ...
      "Tap the URL field, delete it, paste webhook URL below",
      "Tap arrow (▸) or \"Show More\" to expand options",
      "Tap Method → select \"POST\"",
      "Tap \"Add new header\":",
      "   Key: X-Apple-Health-API-Key",
      "   Value: paste your API key (copy below)",
      "Tap Request Body → select \"JSON\"",
      "Tap \"Add new field\":",
      "   Key: steps",
      "   Type: tap and select \"Number\"",
      "   Value: tap the field, look above keyboard for \"Statistics\", tap it",
    ],
    tip: "Statistics appears above keyboard - it's the step total from earlier",
  },
  {
  ...
  {
    title: "Allow Health Sharing",
    action: "Settings",
    instructions: [
      "If you see an error about sharing health items:",
      "Open the Settings app",
      "Go to Shortcuts",
      "Tap Advanced",
      "Turn ON \"Allow Sharing Large Amounts of Data\"",
      "Go back and run the shortcut again",
    ],
    tip: "This lets the shortcut read your step data from Health",
  },
  {
